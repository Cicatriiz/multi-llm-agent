"""Base algorithm class for AB-MCTS tree search."""
...
class Algorithm(Generic[NodeStateT, AlgoStateT], abc.ABC):
    ...
    The Algorithm object itself should be stateless, other than the algorithm 
    configuration which should be specified at object instantiation time.
